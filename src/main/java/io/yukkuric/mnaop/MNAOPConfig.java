...
public class MNAOPConfig {
    ...
    public static ForgeConfigSpec.BooleanValue
            ...
            Cfg_EmpoweredEldrinMatrix = BUILDER.comment("Eldrin Matrices no more diminish when placed more than 1, and will receive multiplier from Eldrin Wellsprings").define("EmpoweredEldrinMatrix", true);
    public static ForgeConfigSpec.DoubleValue
            Cfg_ConstructMilkingCooldown = BUILDER.comment("Configurable construct's milking cooldown (in minutes);\nset to values < 0 to disable this feature").defineInRange("ConstructMilkingCooldown", 3, Double.MIN_VALUE, Double.MAX_VALUE);
    ...
    // caches
    private static boolean cache_FastRegenManaIgnoresSaturation, cache_EmpoweredEldrinMatrix;
